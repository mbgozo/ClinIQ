...
(function (BadgeType) {
    BadgeType["FIRST_ANSWER"] = "FIRST_ANSWER";
    BadgeType["HELPFUL"] = "HELPFUL";
    BadgeType["ACCEPTED"] = "ACCEPTED";
    BadgeType["MENTOR_STAR"] = "MENTOR_STAR";
    BadgeType["AMBASSADOR"] = "AMBASSADOR";
    BadgeType["QUICK_DRAWER"] = "QUICK_DRAWER";
    BadgeType["NIGHT_OWL"] = "NIGHT_OWL";
    BadgeType["EARLY_BIRD"] = "EARLY_BIRD";
    BadgeType["TREND_SETTER"] = "TREND_SETTER";
...
export function getUserLevel(reputation) {
...
export function getNextLevelReputation(currentReputation) {
