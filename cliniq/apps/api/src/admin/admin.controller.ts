...
export class AdminController {
  ...
  @Post('users')
  async createAdminUser(@Request() req, @Body() data: any) {
    const adminId = req.user.sub;
  ...
  @Put('users/:id')
  async updateAdminUser(@Param('id') id: string, @Request() req, @Body() data: any) {
    const adminId = req.user.sub;
  ...
  @Delete('users/:id')
  async deleteAdminUser(@Param('id') id: string, @Request() req) {
    const adminId = req.user.sub;
  ...
  @Get('regular-users')
  async getRegularUsers(@Request() req, @Query() query: { page?: number; limit?: number; search?: string; status?: string }) {
    const adminId = req.user.sub;
  ...
  async banUser(@Param('id') id: string, @Request() req, @Body() body: { reason: string; duration?: number }) {
    const adminId = req.user.sub;
  ...
  async getModerationQueue(@Request() req, @Query() query: { page?: number; limit?: number; status?: string }) {
    const adminId = req.user.sub;
  ...
  async dismissModerationItem(@Param('id') id: string, @Request() req) {
    const adminId = req.user.sub;
  ...
  @Get('analytics/users')
  async getUserAnalytics(@Request() req, @Query() query: { period?: string; metric?: string }) {
    const adminId = req.user.sub;
  ...
  async getContentAnalytics(@Request() req, @Query() query: { period?: string; type?: string }) {
    const adminId = req.user.sub;
  ...
  async getEngagementAnalytics(@Request() req, @Query() query: { period?: string }) {
    const adminId = req.user.sub;
  ...
  async exportData(@Request() req, @Body() body: { type: string; filters?: any; format?: string }) {
    const adminId = req.user.sub;
  ...
  // System Management
  @Get('system/alerts')
  async getSystemAlerts(@Request() req) {
    const adminId = req.user.sub;
  ...
  @Post('system/alerts')
  async createSystemAlert(@Request() req, @Body() data: any) {
    const adminId = req.user.sub;
  ...
  async updateSystemAlert(@Param('id') id: string, @Request() req, @Body() data: any) {
    const adminId = req.user.sub;
  ...
  async deleteSystemAlert(@Param('id') id: string, @Request() req) {
    const adminId = req.user.sub;
  ...
  @Put('system/settings')
  async updateSystemSettings(@Request() req, @Body() data: any) {
    const adminId = req.user.sub;
  ...
  @Get('system/logs')
  async getAdminLogs(@Request() req, @Query() query: { page?: number; limit?: number; adminId?: string; action?: string }) {
    const adminId = req.user.sub;
  ...
  async getQuestions(@Request() req, @Query() query: { page?: number; limit?: number; status?: string; flagged?: boolean }) {
    const adminId = req.user.sub;
  ...
  @Get('content/answers')
  async getAnswers(@Request() req, @Query() query: { page?: number; limit?: number; status?: string; flagged?: boolean }) {
    const adminId = req.user.sub;
  ...
  async getResources(@Request() req, @Query() query: { page?: number; limit?: number; status?: string; flagged?: boolean }) {
    const adminId = req.user.sub;
  ...
  async approveResource(@Param('id') id: string, @Request() req) {
    const adminId = req.user.sub;
  ...
  @Get('study-groups')
  async getStudyGroups(@Request() req, @Query() query: { page?: number; limit?: number; status?: string }) {
    const adminId = req.user.sub;
  ...
  async deleteStudyGroup(@Param('id') id: string, @Request() req) {
    const adminId = req.user.sub;
  ...
  // Chat Management
  @Get('chat/logs')
  async getChatLogs(@Request() req, @Query() query: { page?: number; limit?: number; conversationId?: string; userId?: string }) {
    const adminId = req.user.sub;
  ...
  async deleteChatMessage(@Param('id') id: string, @Request() req) {
    const adminId = req.user.sub;
